...
HD_PWD='C:/Users/MONSTER/Desktop/LECTURES/CS 223/ledTest/ledTest.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log GameClass.vdi -applog -m64 -messageDb vivado.pb -mode batch -source GameClass.tcl -notrace
