...
HD_PWD='C:/Users/MONSTER/Desktop/LECTURES/CS 223/ledTest/ledTest.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log GameClass.vds -m64 -mode batch -messageDb vivado.pb -notrace -source GameClass.tcl
